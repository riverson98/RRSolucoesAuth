...
public class UserConfiguration : IEntityTypeConfiguration<UserEntity>
{
    public void Configure(EntityTypeBuilder<UserEntity> builder)
    {
        ...
        builder.Property(it => it.Name).HasMaxLength(60).IsRequired();
        builder.Property(it => it.Email).HasMaxLength(60).IsRequired();
        builder.Property(it => it.BirthDate).IsRequired();
        builder.Property(it => it.Sex).HasMaxLength(1).IsRequired();
        builder.Property(it => it.PhotoPath);
        builder.Property(it => it.RegistrationDate).IsRequired();
    }
}
